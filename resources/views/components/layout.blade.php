...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('images/chrono-trigger/icon-title-removebg.png') }}">
    ...
    <nav class="navbar bg-base-100">
        ...
        <div class="navbar-center hidden md:flex">
            <div class="navbar-party-frame">
                <img src="{{ asset('images/chrono-trigger/party-lineup-removebg.png') }}"
        ...
        <div class="navbar-end gap-2">
            @auth
                <a href="{{ route('profile.edit') }}" class="text-sm link link-hover">✦ {{ auth()->user()->name }}</a>
